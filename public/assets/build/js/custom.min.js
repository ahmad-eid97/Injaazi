...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        for (var e = [[gd(2012, 1, 1), 17], [gd(2012, 1, 2), 74], [gd(2012, 1, 3), 6], [gd(2012, 1, 4), 39], [gd(2012, 1, 5), 20], [gd(2012, 1, 6), 85], [gd(2012, 1, 7), 7]], a = [[gd(2012, 1, 1), 82], [gd(2012, 1, 2), 23], [gd(2012, 1, 3), 66], [gd(2012, 1, 4), 9], [gd(2012, 1, 5), 119], [gd(2012, 1, 6), 6], [gd(2012, 1, 7), 9]], t = [], n = [[0, 1], [1, 9], [2, 6], [3, 10], [4, 5], [5, 17], [6, 6], [7, 10], [8, 7], [9, 11], [10, 35], [11, 9], [12, 12], [13, 5], [14, 3], [15, 4], [16, 9]], o = 0; o < 30; o++) t.push([new Date(Date.today().add(o).days()).getTime(), randNum() + o + o + 10]);
        var i = {
                series: {
                    lines: {
                        show: !1,
...
function init_JQVmap() {
    ...
    }), $("#iran_map").length && $("#iran_map").vectorMap({
        map: "iran_ir",
        backgroundColor: null,
        color: "#ffffff",
        hoverOpacity: .7,
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var e = {
            ...
            data: {
                labels: ["سیمبین", "بلک بری", "دیگر", "اندروید", "IOS"],
                datasets: [{
                    data: [15, 20, 30, 10, 30],
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (t.maxValue = 6e3, t.animationSpeed = 32, t.set(3200), t.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length) var n = document.getElementById("chart_gauge_02"),
            o = new Gauge(n).setOptions(e);
        $("#gauge-text2").length && (o.maxValue = 9e3, o.animationSpeed = 32, o.set(2400), o.setTextField(document.getElementById("gauge-text2")))
    }
}
    ...
    if ("undefined" != typeof $.fn.cropper) {
        ...
        var e = $("#image"),
            ...
            d = {
                ...
                preview: ".img-preview",
                crop: function (e) {
                    t.val(Math.round(e.x)), n.val(Math.round(e.y)), o.val(Math.round(e.height)), i.val(Math.round(e.width)), r.val(e.rotate), l.val(e.scaleX), s.val(e.scaleY)
                }
            };
        $('[data-toggle="tooltip"]').tooltip(), e.on({
        ...
        }).cropper(d), $.isFunction(document.createElement("canvas").getContext) || $('button[data-method="getCroppedCanvas"]').prop("disabled", !0), "undefined" == typeof document.createElement("cropper").style.transition && ($('button[data-method="rotate"]').prop("disabled", !0), $('button[data-method="scale"]').prop("disabled", !0)), "undefined" == typeof a[0].download && a.addClass("disabled"), $(".docs-toggles").on("change", "input", function () {
            var a, t, n = $(this),
                o = n.attr("name"),
                i = n.prop("type");
            e.data("cropper") && ("checkbox" === i ? (d[o] = n.prop("checked"), a = e.cropper("getCropBoxData"), t = e.cropper("getCanvasData"), d.built = function () {
                e.cropper("setCropBoxData", a), e.cropper("setCanvasData", t)
            }) : "radio" === i && (d[o] = n.val()), e.cropper("destroy").cropper(d))
        }), $(".docs-buttons").on("click", "[data-method]", function () {
            var t, n, o = $(this),
                i = o.data();
            if (!o.prop("disabled") && !o.hasClass("disabled") && e.data("cropper") && i.method) {
                if (i = $.extend({}, i), "undefined" != typeof i.target && (t = $(i.target), "undefined" == typeof i.option)) try {
                    i.option = JSON.parse(t.val())
                } catch (r) {
                    console.log(r.message)
                }
                switch (n = e.cropper(i.method, i.option, i.secondOption), i.method) {
                    case "scaleX":
                    case "scaleY":
                        $(this).data("option", -i.option);
                        break;
                    case "getCroppedCanvas":
                        n && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(n), a.hasClass("disabled") || a.attr("href", n.toDataURL()))
                }
                if ($.isPlainObject(n) && t) try {
            ...
            if (e.data("cropper") && !(this.scrollTop > 300)) switch (a.which) {
                case 37:
                    a.preventDefault(), e.cropper("move", -1, 0);
                    break;
                case 38:
                    a.preventDefault(), e.cropper("move", 0, -1);
                    break;
                case 39:
                    a.preventDefault(), e.cropper("move", 1, 0);
                    break;
...
function init_daterangepicker_reservation() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation"), $("#reservation").daterangepicker(null, function (e, a, t) {
        console.log(e.toISOString(), a.toISOString(), t)
...
function init_EasyPieChart() {
    if ("undefined" != typeof $.fn.easyPieChart) {
        ...
        $.fn.popover.Constructor.prototype.leave = function (e) {
            ...
            a.call(this, e), e.currentTarget && (t = $(e.currentTarget).siblings(".popover"),
                n = o.timeout, t.one("mouseenter", function () {
                    clearTimeout(n), t.one("mouseleave", function () {
    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#canvasDoughnut").length) {
            var e = document.getElementById("canvasDoughnut"),
                a = {
                    labels: ["خاکستری تیر", "رنگ بنفش", "رنگ خاکستری", "رنگ سبز", "رنگ آبی"],
                    datasets: [{
        ...
        if ($("#pieChart").length) {
            var e = document.getElementById("pieChart"),
                a = {
                    ...
                    labels: ["خاکستری تیر", "بنفش", "خاکستری", "سبز", "آبی"]
                };
            new Chart(e, {
                data: a,
                type: "pie",
        ...
        var e, a, t = new Date,
            ...
            r = $("#calendar").fullCalendar({
                ...
                select: function (t, n, o) {
                    $("#fc_create").click(), e = t, ended = n, $(".antosubmit").on("click", function () {
                        var t = $("#title").val();
                        return n && (ended = n), a = $("#event_type").val(), t && r.fullCalendar("renderEvent", {
                            title: t,
                            start: e,
                            end: n,
                            allDay: o,
                            isRTL: !0
                        }, !0), $("#title").val(""), r.fullCalendar("unselect"), $(".antoclose").click(), !1
                    })
                },
                eventClick: function (e, t, n) {
                    $("#fc_edit").click(), $("#title2").val(e.title), a = $("#event_type").val(), $(".antosubmit2").on("click", function () {
                        e.title = $("#title2").val(), r.fullCalendar("updateEvent", e), $(".antoclose2").click()
                    }), r.fullCalendar("unselect")
                },
                editable: !0,
                events: [{
                    title: "تمام روز رویداد",
                    start: new Date(i, o, 1)
                }, {
                    title: "رویداد طولانی",
                    start: new Date(i, o, n - 5),
                    end: new Date(i, o, n - 2)
                }, {
                    title: "ملاقات",
                    start: new Date(i, o, n, 10, 30),
                    allDay: !1
                }, {
                    title: "نهار",
                    start: new Date(i, o, n + 14, 12, 0),
                    end: new Date(i, o, n, 14, 0),
                    allDay: !1
                }, {
                    title: "مهمونی تولد",
                    start: new Date(i, o, n + 1, 19, 0),
                    end: new Date(i, o, n + 1, 22, 30),
                    allDay: !1
                }, {
                    title: "کلیک برای گوگل",
                    start: new Date(i, o, 28),
                    end: new Date(i, o, 29),
                    url: "http://google.com/"
                }]
            })
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        if ($("#mainb").length) {
            var a = echarts.init(document.getElementById("mainb"), e);
            a.setOption({
                title: {
                    text: "عنوان نمودار",
        ...
        if ($("#echart_sonar").length) {
            var t = echarts.init(document.getElementById("echart_sonar"), e);
            t.setOption({
                title: {
        ...
        if ($("#echart_pyramid").length) {
            var n = echarts.init(document.getElementById("echart_pyramid"), e);
            n.setOption({
                title: {
        ...
        if ($("#echart_gauge").length) {
            var o = echarts.init(document.getElementById("echart_gauge"), e);
            o.setOption({
                tooltip: {
                    formatter: "{a} <br/>{b} : {c}%"
                },
        ...
        if ($("#echart_line").length) {
            var i = echarts.init(document.getElementById("echart_line"), e);
            i.setOption({
                title: {
                    text: "نمودار خطی",
                    subtext: "زیر عنوان"
        ...
        if ($("#echart_scatter").length) {
            var r = echarts.init(document.getElementById("echart_scatter"), e);
            r.setOption({
                title: {
        ...
        if ($("#echart_bar_horizontal").length) {
            var a = echarts.init(document.getElementById("echart_bar_horizontal"), e);
            a.setOption({
                title: {
                    text: "نمودار میله‌ای",
                    subtext: "زیر عنوان"
        ...
        if ($("#echart_pie2").length) {
            var l = echarts.init(document.getElementById("echart_pie2"), e);
            l.setOption({
                tooltip: {
                    trigger: "item",
        ...
        if ($("#echart_donut").length) {
            var s = echarts.init(document.getElementById("echart_donut"), e);
            s.setOption({
                tooltip: {
                    trigger: "item",
                    formatter: "{a} <br/>{b} : {c} ({d}%)"
        ...
        if ($("#echart_pie").length) {
            var d = echarts.init(document.getElementById("echart_pie"), e);
            d.setOption({
                tooltip: {
                    trigger: "item",
                    formatter: "{a} <br/>{b} : {c} ({d}%)"
        ...
        if ($("#echart_world_map").length) {
            var p = echarts.init(document.getElementById("echart_world_map"), e);
            p.setOption({
                title: {
